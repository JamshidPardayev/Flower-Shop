  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif' }} className='max-w-[1200px] mx-auto px-[20px] mt-[60px]'>
        <div className='flex flex-col items-center'>
            <h2 className='text-[80px] font-black max-w-[850px] mx-auto text-center leading-[90px] max-md:text-[60px] max-md:leading-[71px] max-sm:text-[40px] max-sm:max-w-[450px] max-sm:leading-[50px]'>Monetize your content with <span className='text-[#46A358]'>GreenShop</span></h2>
